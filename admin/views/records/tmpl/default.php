...
?>
<form action="<?php echo JRoute::_('index.php?option=com_crowdfundingdata&view=records'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <div id="j-main-container">
            ...
            <div id="filter-bar" class="btn-toolbar">
                <div class="filter-search btn-group pull-left">
                    ...
                    <input type="text" name="filter_search" id="filter_search" class="hasTooltip" placeholder="<?php echo JText::_('COM_CROWDFUNDINGDATA_SEARCH'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_CROWDFUNDINGDATA_SEARCH_IN_NAME_TOOLTIP'); ?>" />
                </div>
