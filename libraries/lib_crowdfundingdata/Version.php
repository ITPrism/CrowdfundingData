...
class Version
{
     ...
     * @var string
     */
    public $product = 'Crowdfunding Data';
     ...
     * @var string
     */
    public $url = '<a href="http://itprism.com/help/95-crowdfunding-documentation-faq?start=1#crowdfunding-data" target="_blank">Crowdfunding Data</a>';
     ...
     * @var string
     */
    public $backlink = '<div style="width:100%; text-align: left; font-size: xx-small; margin-top: 10px;"><a href="#" target="_blank">Joomla! Crowdfunding Data</a></div>';
